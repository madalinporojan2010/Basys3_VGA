...
#
# Generated by export_simulation on Sun Oct 30 18:29:42 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './BRAM_img1.sh' script.

./BRAM_img1.sh -reset_run
...
./BRAM_img1.sh -noclean_files

For more information on the script, please type './BRAM_img1.sh -help'.
